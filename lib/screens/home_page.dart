      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 24),
            Text("My Plot", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
            SizedBox(height: 12),
            GestureDetector(
            ...
            SizedBox(height: 24),
            Text("Crop Growth", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
            SizedBox(height: 12),
            _placeholderRounded(height: 180, label: "Crop Growth: Add your details"),

            SizedBox(height: 24),
            Row(
              children: [
                Expanded(child: _placeholderRounded(height: 100, label: "Overall Growth: Add your details")),
                SizedBox(width: 16),
                Expanded(child: _placeholderRounded(height: 100, label: "Yield Projection: Add your details")),
              ],
            ),

            SizedBox(height: 24),
            Text("Pending Tasks", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
            SizedBox(height: 12),
            GestureDetector(
